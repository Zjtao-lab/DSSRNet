...
#     --master_port=4321 basicsr/test.py -opt options/test_finetuneHat/NAFSSR-S_2x_down_reallr.yml --launcher pytorch
...
nohup /home/thinkstation03/anaconda3/envs/hat/bin/python -m torch.distributed.launch \
    --nproc_per_node=2 --master_port=4322 basicsr/train.py \
    -opt options/ablation_train/NAFSSR-S_x2_down_reallr__wLateFFB.yml --launcher pytorch \
    > ../ablation_log/ablation-S_x2_down_reallr__wLateFFB.txt 2>&1 &
