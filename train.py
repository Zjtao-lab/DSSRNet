...
def main():
    ...
    log_file = None
    msg_logger = MessageLogger(opt, current_iter, tb_logger, log_file=log_file)
    # tb_logger
    ...
    while current_iter <= total_iters:
        ...
        while train_data is not None:
            ...
            loss_batch = model.get_current_log()
            for loss_type in loss_batch:
                freq_pr_loss += loss_batch[loss_type]
            ...
            if current_iter % opt['logger']['print_freq'] == 0:
                ...
                log_vars.update({'freq_pr_loss': freq_pr_loss})
                freq_pr_loss = 0
                msg_logger(log_vars)
            ...
            # validation
            if (1==1 and (opt.get('val') is not None and (current_iter % opt['val']['val_freq'] == 0 # or current_iter == 200
                                                          or current_iter == 1000 # or current_iter == 3000 # or current_iter == 3000
                                                          # or current_iter == 4000 or current_iter == 6000
                                                          ))): # 1000))):
