...
class MessageLogger():
    ...
    def __init__(self, opt, start_iter=1, tb_logger=None, log_file=None):
    ...
    def __call__(self, log_vars):
        ...
        if 'time' in log_vars.keys():
            ...
            message += f'time (s/{self.interval} iter):{(iter_time-data_time)*self.interval:.1f}] '
